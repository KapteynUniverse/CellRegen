      ...
      <div className="wrapper">
        ...
        <div className="flex">
          <article className="grid lg:grid-cols-[24]">
            ...
            />
            <div className="lg:col-start-11 lg:col-end-[24] lg:row-start-1 lg:row-end-1 bg-secondaryBg text-secondaryFg mt-7">
              <h3>
              ...
              <p>
                ...
                certain supplements may help support blood sugar control
                alongside your regular medication and healthy lifestyle choices.
                When shopping for...
              </p>
